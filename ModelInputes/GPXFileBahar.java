...
/**
 * A simple utility method to import Csv files.
 * <p>
 * @author Bahar Zarin
 */
public class GPXFileBahar {
	//our format 2015-06-01T11:05:32.000Z
    ...
    public GPXFileBahar(List<GPXEntry> entries) {
        this.entries = entries;
    }

/*    public GPXFileBahar(MatchResult mr, InstructionList il) {
    ...
    public GPXFileBahar doImport(String fileStr) {
        try {
     ...
     */
    public GPXFileBahar doImport(InputStream is, double defaultSpeed) {
    ...
    public GPXFileBahar doExport(String gpxFile) {
